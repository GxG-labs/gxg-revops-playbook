...
Do NOT use when: {common mistrigger situation — helps the agent avoid activating incorrectly}
...
**Output:**
{What the agent should produce — be specific, show the actual format}
