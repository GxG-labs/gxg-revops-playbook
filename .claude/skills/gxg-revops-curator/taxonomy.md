...
| `scripts/` | Python/bash scripts Claude can execute |
...
Give Claude the ability to do something it couldn't do alone — tool-specific workflows, proprietary processes, custom integrations.
Examples: `auditing-crm-data` (Salesforce-specific), `forecasting-pipeline` (Clari-specific)

### Encoded Preference Skills
Capture GxG's specific way of doing something Claude already knows — our scoring model, our stage definitions, our qualification criteria.
